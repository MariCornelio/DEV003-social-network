...
jest.mock('firebase/auth', () => {
  ...
  const newMod = { ...originalModule };
  newMod.createUserWithEmailAndPassword = jest.fn().mockImplementation((auth, email, password) => Promise.resolve({ user: { id: 'hello im a mock', email, password } }));
  newMod.createUserWithEmailAndPassword = jest.fn().mockImplementation(
